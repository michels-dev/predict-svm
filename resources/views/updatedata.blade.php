	...
	<div class="card mt-2">
		...
		<div class="card-body justify-">
			<form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					<input type="text" name="age" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Input Umur Anda" value="{{ $data->age }}">
				</div>
				<div class="mb-3">
					<select class="form-select" name="hypertension" arial-label="Default select example">
						<option selected>{{ $data->hypertension }}</option>
						<option value="0">Tidak Hipertensi</option>
						<option value="1">Hipertensi</option>
				</div>
				<div class="mb-3">
					<input type="text" name="heart_disease" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Input Penderita Jantung" value="{{ $data->heart_disease }}">
				...
				<div class="mb-3">
					<input type="text" name="avg_gluose_level" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Input Kadar Glukosa" value="{{ $data->avg_gluose_level }}">
				</div>
				<div class="mb-3">
					<input type="text" name="bmi" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Input Indeks Masa Tubuh" value="{{ $data->bmi }}">
				</div>
				<div class="mb-3">
					<select class="form-select" name="smoking_status" arial-label="Default select example">
						<option selected>{{ $data->smoking_status }}</option>
						<option value="0">Belum Pernah Merokok</option>
						<option value="1">Sebelumnya Merokok</option>
						<option value="2">Merokok</option>
				</div>
				<div class="mb-3">
					<input type="text" name="stroke" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Input Penderita Penyakit Stroke" value="{{ $data->stroke }}">
